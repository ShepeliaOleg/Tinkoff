...
public class FullCalculatorTest {
    ...
    FullCalculatorMethods methods = new FullCalculatorMethods();
    ...
    public void firstM () throws Exception {
        ...
        methods.selectDate(driver,"Дата выдачи", "Февраль", 2013, 4);
        methods.enterDate(driver, "Дата рождения", "04.06.1996");

...
public class FullCalculatorMethods {


    public void addDriver (WebDriver driver) throws InterruptedException {

        Thread.sleep(3000);
        WebElement tabDriver = driver.findElement(By.xpath("//*[contains(@class,'rich-tab-header rich-tab-inactive')]" +
                "[contains(text(), 'Водители')]"));
        tabDriver.click();
        Thread.sleep(5000);

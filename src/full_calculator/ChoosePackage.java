...
public class ChoosePackage {
    ...
    public void test (WebDriver driver, String lableName, int numberOfColumn) throws InterruptedException {
        ...
        WebElement checkbox = driver.findElement(By.xpath("//*[contains(text(), 'Расши')]/following-sibling::td[2]/span/input[contains(@type, 'checkbox')]"));

        checkbox.click();

        List<WebElement> elementList = driver.findElements(By.xpath("//*[contains(text(), 'Расши')]/following-sibling::td[2]/span/select/option"));
